import { bhadrakali, brahmSarovar, dharohar, harshTilla, jyotisar, panorama, sheikhChilli, shriKrishnaMuseum, sthaneswar, tirupatiBalaji } from "../images/images";

export let touristSpotData = [
    {
        id:1,
    ...
    {
        id:8,
        title:"DAROHAR MUSEUM",
        image:dharohar,
        about:["In its golden jubilee year, the Kurukshetra University established within the campus, Dharohar, a museum to showcase the unique archeological, cultural and architectural heritage of Haryana. It also has an open-air theatre for cultural performances.Here , you can just expierence the heritage of Haryana very easily and in creative way."]
    },
    {
        id:9,
        title:"STHANESHWAR MAHADEV MANDIR",
        image:sthaneswar,
        about:[
